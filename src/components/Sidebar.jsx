                ...
                <ul className="space-y-1">
                    ...
                    <li>
                        <button
                            ...
                            className={`w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 font-medium cursor-pointer group ${isFinanceActive && !financeOpen ? 'text-[var(--dashboard-primary)] bg-[var(--dashboard-secondary)]' : 'text-[var(--sidebar-inactive-text)] hover:bg-[var(--dashboard-secondary)]'
                                }`}
                        >
