...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen w-64 bg-[var(--sidebar-bg)] border-r border-[var(--border-color)] flex flex-col fixed left-0 top-0 z-50 overflow-y-auto transition-colors duration-300">
