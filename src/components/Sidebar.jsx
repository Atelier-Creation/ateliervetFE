...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen w-64 bg-[var(--sidebar-bg)] border-r border-gray-200 flex flex-col fixed left-0 top-0 z-50 overflow-y-auto">
            <div className="p-6 pb-4 border-b border-gray-200 flex items-center">
