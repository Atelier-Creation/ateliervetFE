    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-5 duration-500">
            ...
            <div className="bg-[var(--card-bg)] p-6 rounded-2xl shadow-sm border border-[var(--border-color)]">
                ...
                <div className="bg-purple-100/50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800/30 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                    ...
                    <div className="flex items-center gap-3">
                        <span className="px-3 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300 text-xs font-bold rounded-md uppercase tracking-wide">
                            {upcomingAppointment.status}
                        </span>
                        <button className="px-4 py-2 bg-white dark:bg-gray-800 text-xs font-bold rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">
                            View
                        </button>
                    </div>
                </div>
